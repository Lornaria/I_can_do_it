...
extern FileLogger g_logger; //******************* added for lesson 7 **********************************************************
    ...
    score(0)
{
    ...
    g_logger.Write(string(__FUNCTION__) + " was invoked"); //******************* added for lesson 7 **********************************************************
...
void SBomber::ProcessKBHit()
{
    ...
    g_logger.Write(string(__FUNCTION__) + " was invoked. key = ", c); //******************* added for lesson 7 **********************************************************
...
void SBomber::TimeFinish()
{
    ...
    g_logger.Write(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime); //******************* added for lesson 7 **********************************************************
}
