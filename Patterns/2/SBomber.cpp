...
void SBomber::CheckBombsAndGround() 
{
    ...
    for (size_t i = 0; i < vecBombs.size(); i++)
    {
        if (vecBombs[i]->GetY() >= y) // Пересечение бомбы с землей
        {
            ...
            CommandDeleteDynamicObj* pCommand = new CommandDeleteDynamicObj;
            pCommand->SetParams(vecBombs[i], vecDynamicObj);
...
void SBomber::CheckDestoyableObjects(Bomb * pBomb)
{
    ...
    for (size_t i = 0; i < vecDestoyableObjects.size(); i++)
    {
        ...
        if (vecDestoyableObjects[i]->isInside(x1, x2))
        {
            ...
            CommandDeleteStaticObj* pCommand = new CommandDeleteStaticObj;
            pCommand->SetParams(vecDestoyableObjects[i], vecStaticObj);
            CommandExecuter(pCommand);
...
void SBomber::ProcessKBHit()
{
    ...
    CommandDropBomb* pCommand = new CommandDropBomb;
    ...
    case 'b':
        pCommand->SetParams(vecDynamicObj, pPlane, bombsNumber, score);
        CommandExecuter(pCommand);
        //DropBomb();
        break;
